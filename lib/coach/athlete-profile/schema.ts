...
export const athleteProfileSchema = z.object({
  ...
  weightClass: z.string().trim().max(20).optional().nullable(),
  ...
  weakPoints: z.string().trim().max(2000).optional().nullable(),
  injuryHistory: z.string().trim().max(4000).optional().nullable(),
  ...
  meetName: z.string().trim().max(120).optional().nullable(),
